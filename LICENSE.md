...
Everything under `scripts/` is licensed under the **MIT Licence**.

## What is not ours

Source URLs point at third-party material that keeps its own licence. Product photographs are
each tagged with their licence in the entry's `images` block. Brand names and logos belong to
their owners and appear here for identification only.
